 ...
 * @author Tim Fennell
 */
public class CustomLocalePicker implements LocalePicker {

    /** Log instance for use within the class. */
	private final static Logger logger = LoggerFactory.getLogger(CustomLocalePicker.class);
    ...
    @Inject
    public CustomLocalePicker(Injector anInjector) {
    ...
    public void init(Configuration configuration) throws Exception {
    	logger.debug("Inicializando componente CustomLocalePicker");
    }
...
//    	SampleService ss = theInjector.getInstance(SampleService.class);
//    	List<Language> systemLanguages = ss.getAllLanguages();
    	List<Language> systemLanguages = Collections.emptyList();
