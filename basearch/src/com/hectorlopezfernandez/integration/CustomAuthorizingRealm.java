...
public class CustomAuthorizingRealm extends AuthorizingRealm {
	...
	private final static Logger logger = LoggerFactory.getLogger(CustomAuthorizingRealm.class);

	//FIXME recuperar los permisos del usuario particular
	@Override
	...
	protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
		...
		AuthenticationInfo ai = new SimpleAuthenticationInfo(u.getId(), u.getPassword(), ByteSource.Util.bytes(u.getUsername()), "AppAuthorizingRealm");
	...
	//FIXME esto se debería hacer por inyección, pero el orden de los filtros hace que sea difícil
